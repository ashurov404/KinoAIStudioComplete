...
V01 is an in-place upgrade of the V8 codebase. It does not replace the software 3D core.
...
- The V01.1 admin UI is intentionally limited to advertising/collaboration payment approval/rejection.


## V01.1 — 7 ta majburiy tuzatish
